...
class User
{
    ...
    function update()
    {
        ...
        $prep_state->bindParam(':firstname', $this->firstname,PDO::PARAM_STR,100);
        $prep_state->bindParam(':lastname', $this->lastname,PDO::PARAM_STR,100);
        $prep_state->bindParam(':email', $this->email,PDO::PARAM_STR,100);
        $prep_state->bindParam(':mobile', $this->mobile,PDO::PARAM_STR,30);
